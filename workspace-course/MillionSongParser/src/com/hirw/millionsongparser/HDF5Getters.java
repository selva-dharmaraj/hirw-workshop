package com.hirw.millionsongparser;
...
public class HDF5Getters
{
    ...
    public static void extractJustNeededSongInfo(String filename, FileWriter fw) {
    	...
    	try {
    	    ...
    	    String artistFamiliarity = new Double(get_artist_familiarity(h5)).toString();
    	    fw.write(artistFamiliarity.equals("NaN") ? "\t" : artistFamiliarity+"\t");
    ...
    public static void extractSongInfo(String filename, FileWriter fw) {
    	...
    	try {
    	    ...
    	    String artistFamiliarity = new Double(get_artist_familiarity(h5)).toString();
    	    fw.write(artistFamiliarity.equals("NaN") ? "\t" : artistFamiliarity+"\t");
    	    String artistHotness = new Double(get_artist_hotttnesss(h5)).toString();
    	    fw.write(artistHotness.equals("NaN") ? "\t" : artistHotness+"\t");
    	    ...
    	    fw.write(get_artist_name(h5)+"\t");
    	    System.out.println(get_artist_name(h5));
    ...
    public static void browseFolder(String foldername, FileWriter fw) {
		...
		for(File file : listOfFiles) {
			if(file.isFile())
				//To extract all information from dataset
				//extractSongInfo(file.getAbsolutePath(), fw);
				
				//To extract just the needed information from dataset
				extractJustNeededSongInfo(file.getAbsolutePath(), fw);
			else
    ...
    public static void main(String[] args) throws IOException
    {
		...
		File fileToWrite = new File("C:\\Hadoop\\MillionSongDataset\\output\\songs-dataset-sample.new");
